...
def main():
    ...
    parser.add_argument(
        "--node_input_size", type=int, default=4, help="Dimension of the node features"
    )
    parser.add_argument(
        "--edge_input_size",
        type=int,
    ...
    parser.add_argument(
        "--node_output_size", type=int, default=6, help="Dimension of the node output"
    )
    ...
    # Sequence length
    parser.add_argument("--obs_length", type=int, default=31, help="Sequence length")
    # parser.add_argument(
...
def train(args):
    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in range(dataloader.num_batches):
            ...
            current_seq_length = seq_length[current_dataset_index]
        ...
        logging.info("(epoch {}), loss = {:.3f}".format(epoch, loss_epoch))
        logging.info(
    ...
    # Log it
    log_file.write(str(best_epoch) + "," + str(best_loss))

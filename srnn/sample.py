...
def main():
    ...
    min_heading = dataloader.min_heading
    max_heading = dataloader.max_heading
    ...
    for batch in range(dataloader.num_batches):
        ...
        # 反归一化操作
        ret_nodes[:, :, 0] = ((ret_nodes[:, :, 0] + 1) / 2) * (max_position_x - min_position_x) + min_position_x
        ret_nodes[:, :, 1] = ((ret_nodes[:, :, 1] + 1) / 2) * (max_position_y - min_position_y) + min_position_y
